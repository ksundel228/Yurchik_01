...
class Matrix
{
    ...
    /// <param name="minValue">Минимальное значение для генерации случайных чисел (по умолчанию 0).</param>
    /// <param name="maxValue">Максимальное значение для генерации случайных чисел (по умолчанию 10).</param>
    ...
    /// <summary>
    /// Перегрузка операции умножения двух матриц.
    /// </summary>
    /// <param name="a">Первая матрица.</param>
    /// <param name="b">Вторая матрица.</param>
    /// <returns>Результирующая матрица после умножения.</returns>
    /// <exception cref="InvalidOperationException">Выбрасывается, если размеры матриц не согласованы для умножения.</exception>
...
/// <summary>
/// Главный класс программы, выполняющий демонстрацию операций над матрицами.
/// </summary>
class Program
{
    /// <summary>
    /// Точка входа в программу. Создает случайные матрицы, выполняет их умножение и выводит результаты.
    /// </summary>
    static void Main()
    {
